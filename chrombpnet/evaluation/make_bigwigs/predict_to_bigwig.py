...
def parse_args():
    ...
    parser.add_argument("-em", "--encoding-method", type=str, default="one_hot", choices=["one_hot", "simplex_monomer", "simplex_dimer", "scalar", "simplex_monomer_scalar"], help="Encoding method for input DNA sequences")
