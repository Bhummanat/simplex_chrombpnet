...
def fetch_variant_args():
    ...
    parser.add_argument("-em", "--encoding_method", type=str, default="one_hot", choices=["one_hot", "simplex_monomer", "simplex_dimer", "scalar", "simplex_monomer_scalar"], help="Encoding method to use for SNP sequence conversion")
